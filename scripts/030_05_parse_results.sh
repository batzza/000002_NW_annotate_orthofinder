...
python 030_15_summarize_orthogroups.py -i ../data/030_key_orthogroups/by_gene/ -d /data/VisionEvo/OrthoFinder/concat_unigene_108/OrthoFinder/Results_Feb04/Orthogroup_Sequences/ -o ../data/030_key_orthogroups/ -g ../data/000_raw/Group_info.csv
